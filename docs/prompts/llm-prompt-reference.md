...
#### NEVER Do This
- ❌ Synthesize or guess what code looks like
- ❌ Copy code snippets from tool output without verification
- ❌ Write `Vulnerable Code` sections without reading the actual file
- ❌ Invent variable names, function signatures, or code patterns
...
```
**🔍 Guard Check:** [What to check for this rule type]
...
- Context hints (⚠️ Test code, ⚠️ Example code, etc.)
- Code evidence (up to 8 lines of MIR)
- **🔍 Guard Check** hints (rule-specific patterns to verify)
