...
impl DivisionByUntrustedRule {
    ...
    fn track_untrusted_numerics(body: &[String]) -> HashSet<String> {
        ...
        let source_patterns = rules::utils::INPUT_SOURCE_PATTERNS;
...
fn register_builtin_rules(engine: &mut RuleEngine) {
    ...
    // Remaining injection rules (complex, require taint tracking - migrate incrementally)
