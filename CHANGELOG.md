...
### Security
- **Upgraded reqwest**: Updated from 0.11 to 0.12 to address transitive dependency vulnerabilities
- **Fixed RUSTSEC-2026-0007**: Added explicit `bytes >= 1.11.1` dependency to patch integer overflow in `BytesMut::reserve`
